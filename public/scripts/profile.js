...
storedLoginIdentifier = localStorage.getItem('loginIdentifier');
    ...
    fetch(`/api/v1/user/getuser/${loginIdentifier}`)
        ...
        .then(data => {
            if (data.success) {
                ...
                document.getElementById('inputBirthday').value = data.data.dayOfBỉth || '';
            } else {
...
function saveChanges() {
    ...
    fetch(`/api/v1/user/updateuser/${storedLoginIdentifier}`, {
        method: 'PUT',
        headers: {
